...
public enum MaterialClassType {
    SWORDS(Arrays.asList("GOLDEN_SWORD", "STONE_SWORD", "WOODEN_SWORD", "NETHERITE_SWORD", "DIAMOND_SWORD", "IRON_SWORD", "COPPER_SWORD")),
    BOWS(Collections.singletonList("BOW")),
    CROSSBOWS(Collections.singletonList("CROSSBOW")),
    TRIDENTS(Collections.singletonList("TRIDENT")),
    SPEARS(Arrays.asList("WOODEN_SPEAR", "STONE_SPEAR", "GOLDEN_SPEAR", "IRON_SPEAR", "DIAMOND_SPEAR", "NETHERITE_SPEAR", "COPPER_SPEAR")),
    HELMETS(Arrays.asList("PLAYER_HEAD", "SKELETON_SKULL", "ZOMBIE_HEAD", "WITHER_SKELETON_SKULL", "CARVED_PUMPKIN", "LEATHER_HELMET", "CHAINMAIL_HELMET", "GOLDEN_HELMET", "IRON_HELMET", "DIAMOND_HELMET", "NETHERITE_HELMET", "TURTLE_HELMET", "COPPER_HELMET")),
    CHESTPLATES(Arrays.asList("LEATHER_CHESTPLATE", "CHAINMAIL_CHESTPLATE", "GOLDEN_CHESTPLATE", "IRON_CHESTPLATE", "DIAMOND_CHESTPLATE", "NETHERITE_CHESTPLATE", "COPPER_CHESTPLATE")),
    LEGGINGS(Arrays.asList("LEATHER_LEGGINGS", "CHAINMAIL_LEGGINGS", "GOLDEN_LEGGINGS", "IRON_LEGGINGS", "DIAMOND_LEGGINGS", "NETHERITE_LEGGINGS", "COPPER_LEGGINGS")),
    BOOTS(Arrays.asList("LEATHER_BOOTS", "CHAINMAIL_BOOTS", "GOLDEN_BOOTS", "IRON_BOOTS", "DIAMOND_BOOTS", "NETHERITE_BOOTS", "COPPER_BOOTS")),
    ...
    PICKAXES(Arrays.asList("WOODEN_PICKAXE", "STONE_PICKAXE", "GOLDEN_PICKAXE", "IRON_PICKAXE", "DIAMOND_PICKAXE", "NETHERITE_PICKAXE", "COPPER_PICKAXE")),
    AXES(Arrays.asList("WOODEN_AXE", "STONE_AXE", "GOLDEN_AXE", "IRON_AXE", "DIAMOND_AXE", "NETHERITE_AXE", "COPPER_AXE")),
    SHOVELS(Arrays.asList("WOODEN_SHOVEL", "STONE_SHOVEL", "GOLDEN_SHOVEL", "IRON_SHOVEL", "DIAMOND_SHOVEL", "NETHERITE_SHOVEL", "COPPER_SHOVEL")),
    HOES(Arrays.asList("WOODEN_HOE", "STONE_HOE", "GOLDEN_HOE", "IRON_HOE", "DIAMOND_HOE", "NETHERITE_HOE", "COPPER_HOE")),
